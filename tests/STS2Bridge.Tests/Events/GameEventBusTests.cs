...
public sealed class GameEventBusTests
{
    ...
    {
        var bus = new GameEventBus(2, new[] { EventTypes.CombatStarted, EventTypes.CardPlayed });
        ...
        var second = new GameEvent("evt-2", EventTypes.CardPlayed, "run-1", 1, "MonsterRoom", new { cardId = "strike" });
